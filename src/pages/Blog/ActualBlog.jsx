...
export default function ActualBlog(props) {
    const some = () => "As the dates of <strong>Patna University</strong> exams are announced";
    return (
        <>
            <Container>
                <Row>
